  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center">
        <div>
          <h2 className="text-2xl font-bold text-gray-800">Ø¥Ø¯Ø§Ø±Ø© Ø§Ù„Ù…ÙˆØ±Ø¯ÙŠÙ†</h2>
          <p className="text-gray-500 text-sm mt-1">Ø¥Ø¬Ù…Ø§Ù„ÙŠ {suppliers.length} Ù…ÙˆØ±Ø¯</p>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-gray-500 text-sm">Ø¥Ø¬Ù…Ø§Ù„ÙŠ Ø§Ù„Ù…ÙˆØ±Ø¯ÙŠÙ†</p>
            ...
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">Ù…ÙˆØ±Ø¯ Ù…Ù†Ø° {formatDateDisplay(supplier.createdAt)}</p>
                </div>
              </div>
...
{hasPermission(user, 'sales:write') && (
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-center gap-2 text-gray-600">
                ...
                <span>{supplier.address || 'Ø¨Ø¯ÙˆÙ† Ø¹Ù†ÙˆØ§Ù†'}</span>
              </div>
              <div className="flex items-center gap-2 text-gray-600">
          ...
          <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl">
            <div className="p-6 border-b border-gray-100">
              <h3 className="text-xl font-bold text-gray-800">
                {editingSupplier ? 'ØªØ¹Ø¯ÙŠÙ„ Ù…ÙˆØ±Ø¯' : 'Ø¥Ø¶Ø§ÙØ© Ù…ÙˆØ±Ø¯ Ø¬Ø¯ÙŠØ¯'}
              </h3>
            </div>
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div className="flex gap-3 pt-4">
                ...
                >
                  {editingSupplier ? 'ØªØ­Ø¯ÙŠØ«' : 'Ø¥Ø¶Ø§ÙØ©'}
                </button>
              </div>
            </form>
          </div>
